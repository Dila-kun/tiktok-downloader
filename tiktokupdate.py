...
#api = TikTokApi();
#verifyFp="verify_kqccru6a_EwxYgvBQ_Ms3F_4Mz9_Aec5_b386WHa4F45i"
...
api = TikTokApi.get_instance(request_delay = 1, custom_verifyFp = "verify_683ceb84ad8a69c8cb832acbe2dabf19");

def getAllUserVideos(user_name):
    videos_id = list(())
    user_videos = api.by_username(user_name, 100)
